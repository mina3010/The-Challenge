                        ...
                        if (doc.exists()) {
                            ...
                            for (int i = 1; i <= count; i++) {
                                if (doc.getString("USER" + String.valueOf(i) + "_ID").equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
                                    ...
                                    userList.add(new UserData(userID, userName, userEmail, userPassword, userNumber, userType, "1", userLan, userLng));
                                }
                            }
                            if (df != null) {
                                df.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                    ...
                                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                                        if (documentSnapshot.exists()) {
                                            ...
                                            } else if (documentSnapshot.getString("TYPE").equals("user")) {
